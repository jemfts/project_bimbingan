      ...
      <div class="card-content">
        <form class="row" id="add-user-form" method="post" action="">
          ...
          <div class="input-field col s12 m6">
              ...
              <div class="input-field col s12 m6">
                  <input id="tgl_lahir" name="tgl_lahir" type="date" value="<?php echo $this->session->userdata('tgl_lahir'); ?>">
              ...
              <div class="input-field col s12 m6">
                  <input id="no_hp" name="no_hp" type="number" value="<?php echo $this->session->userdata('no_hp'); ?>">
                  <label for="no_hp" class="active">No. HP</label>
              </div>
              <div class="input-field col s12 m6">
                  <input id="nama_wali_murid" name="nama_wali_murid" type="text" value="<?php echo $this->session->userdata('nama_wali_murid'); ?>">
                  <label for="nama_wali_murid" class="active">Nama Wali Murid</label>
              </div>
              <div class="input-field col s12 m6">
                  <input id="email_wali_murid" name="email_wali_murid" type="email" value="<?php echo $this->session->userdata('email_wali_murid'); ?>">
