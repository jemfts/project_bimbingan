...
<html lang="en">
  ...
  <head>
    ...
    <title>BK SMA 1 Barunawati</title>
    <!-- CSS  -->
  ...
  <body>
    <nav class="light-blue lighten-1" role="navigation">
      <div class="nav-wrapper container"><a id="logo-container" href="<?php echo base_url(); ?>" class="brand-logo">BK SMA 1 Barunawati</a></div>
    </nav>
                ...
                <div class="row">
                 ...
                 <div class="input-field col m12">
                  ...
                  <div class="input-field col m12 right-align">
                    <button class="btn waves-effect waves-light btn-login success" type="submit" name="submit" value="login">
    ...
    <footer class="page-footer white">
      <div class="footer-copyright  blue darken-3">
        <div class="container center-align">
          Copyright &copy; <a class="white-text text-lighten-3" href="">Kcdev Interactive Software</a>
        </div>
      </div>
    </footer>
